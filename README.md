...
1. Download the 'FEC-proxy.pem' file. Oh look, a neat link to download it:  <a download='FEC-proxy.pem' href='https://github.com/hrden05/proxy/blob/master/FEC-proxy.pem'>Whattt?</a>   [whattt?](https://raw.githubusercontent.com/hrden05/proxy/FEC-proxy.pem)
